...
## Running
Tests can be run either against locally provisioned environment or any other one, as long as ``DIRECTORY_TESTS_DIRECTORY_API_URL`` and ``DIRECTORY_TESTS_DIRECTORY_UI_BUYER_URL`` environment variables are set.
...
- ``DIRECTORY_API_URL``, ``DIRECTORY_SSO_URL``, ``DIRECTORY_UI_BUYER_URL`` The urls you want to load test.
...
Requires just ``DIRECTORY_TESTS_DIRECTORY_API_URL`` and ``DIRECTORY_TESTS_DIRECTORY_UI_BUYER_URL`` environment variables to be set.
...
| DIRECTORY_TESTS_DIRECTORY_UI_BUYER_LOAD_URL | DIRECTORY_UI_BUYER_LOAD_URL |
