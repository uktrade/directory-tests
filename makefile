...
DOCKER_SET_DIRECTORY_API_ENV_VARS := \
	...
	export DIRECTORY_API_DB_NAME=directory_api_test,sso_test; \
	export DIRECTORY_API_DB_PASS=test; \
	export DIRECTORY_API_DB_USER=test; \
...
DOCKER_SET_DIRECTORY_SSO_ENV_VARS := \
   ...
   export SSO_DB_USER=test; \
   export SSO_DB_PASS=test; \
   export SSO_DB_NAME=directory_tests; \
