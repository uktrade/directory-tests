...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SERVICE_NAMES.INVEST, "invest-", "energy-waste"),
        ...
        (SERVICE_NAMES.INVEST, "invest-", "free-foods"),
        ...
        (SERVICE_NAMES.INVEST, "invest-", "south-england"),
        (SERVICE_NAMES.INVEST, "invest-", "wales"),

        (SERVICE_NAMES.INVEST, "invest-", "setup-guide-landing-page"),
        (SERVICE_NAMES.INVEST, "invest-", "apply-uk-visa"),
        (SERVICE_NAMES.INVEST, "invest-", "establish-base-business-uk"),
        (SERVICE_NAMES.INVEST, "invest-", "hire-skilled-workers-your-uk-operations"),
        (SERVICE_NAMES.INVEST, "invest-", "open-uk-business-bank-account"),
        (SERVICE_NAMES.INVEST, "invest-", "setup-your-business-uk"),
