...
READ_COUNTER = Selector(By.CSS_SELECTOR, "#articles .scope-indicator .position > span.from")
TOTAL_ARTICLES = Selector(By.CSS_SELECTOR, "#articles .scope-indicator .position > span.to")
...
MARKET_RESEARCH_LINK = Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/market-research/']")
CUSTOMER_INSIGHT_LINK = Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/customer-insight/']")
FINANCE_LINK = Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/finance/']")
BUSINESS_LINK = Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/business-planning/']")
GETTING_PAID_LINK = Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/getting-paid/']")
OPERATIONS_AND_COMPLIANCE_LINK = (
    Selector(By.CSS_SELECTOR, "#resource-guidance a[href='/operations-and-compliance/']")
)
TOP_IMPORTER = Selector(By.ID, "top_importer_name")
TOP_IMPORTERS = Selector(By.CSS_SELECTOR, "#content > section.top-markets > div > ol > li > dl")
...
SELECTORS = {
    "hero": {
        ...
        "update preferences link": Selector(By.CSS_SELECTOR, "section.intro-section a.preferences"),
    },
    "facts": {
    ...
    "articles": {
        ...
        "article list": Selector(By.CSS_SELECTOR, "#persona-overview div.section-content-list"),
    },
    "top 10": {
        ...
        "source data": Selector(By.CSS_SELECTOR, "section.top-markets #market-source-data"),
    },
    "services": {
    ...
    "fab section": {
        ...
        "create a business profile": Selector(By.CSS_SELECTOR, "section.service-section.fas .intro .button"),
    },
    "exopps tile": {
        "heading": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(2) h3"),
        "exopps image": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(2) img"),
        "intro": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(2) p"),
        "find marketplaces link": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(2) a"),
    },
    "exopps section": {
        ...
        "find marketplaces button": Selector(By.CSS_SELECTOR, "section.service-section.soo .intro .button"),
    },
    "soo section": {
        "heading": Selector(By.CSS_SELECTOR, "section.service-section.soo h2"),
    ...
    "soo tile": {
        "heading": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(1) h3"),
        "soo image": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(1) img"),
        "intro": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(1) p"),
        "find marketplaces link": Selector(By.CSS_SELECTOR, "#other-services div.lg-2:nth-child(1) a"),
    },
    "article list": {
    ...
    "case studies": {
        ...
        "previous article": Selector(By.CSS_SELECTOR, "#carousel label.ed-carousel__control--backward"),
        "next article": Selector(By.CSS_SELECTOR, "#carousel label.ed-carousel__control--forward"),
        "case study head link": Selector(By.CSS_SELECTOR, ".ed-carousel__track > div:nth-child(1) h3 a"),
        "case study intro": Selector(By.CSS_SELECTOR, ".ed-carousel__track > div:nth-child(1) p"),
        "case study intro link": Selector(By.CSS_SELECTOR, ".ed-carousel__track > div:nth-child(1) div > a"),
        "carousel indicator #1": Selector(By.CSS_SELECTOR, "#carousel .ed-carousel__indicator[for='1']"),
        "carousel indicator #2": Selector(By.CSS_SELECTOR, "#carousel .ed-carousel__indicator[for='2']"),
        "carousel indicator #3": Selector(By.CSS_SELECTOR, "#carousel .ed-carousel__indicator[for='3']"),
    },
}
...
def should_see_read_counter(
    ...
    counter = find_element(
        driver, READ_COUNTER, element_name="Article Read Counter"
    )
