...
ADVICE_MARKET_RESEARCH_ARTICLES = [
    RESEARCH_YOUR_MARKET,
    DEFINE_MARKET_POTENTIAL,
    DO_FIELD_RESEARCH,
    ANALYSE_THE_COMPETITION,
...
ADVICE_CUSTOMER_INSIGHT_ARTICLES = [
    KNOW_YOUR_CUSTOMERS_AND_PARTNERS,
    MEET_YOUR_CUSTOMER,
    MANAGE_LANGUAGE_DIFFERENCES,
    UNDERSTAND_YOUR_CUSTOMERS_CULTURE,
...
ADVICE_BUSINESS_PLANNING_ARTICLES = [
    MAKE_EXPORTING_PLAN,
    FIND_A_ROUTE_TO_MARKET,
    SELL_OVERSEAS_DIRECTLY,
    USE_OVERSEAS_AGENT,
...
ADVICE_OPERATIONS_AND_COMPLIANCE_ARTICLES = [
    ANTI_BRIBERY_AND_CORRUPTION_TRAINING,
    PLAN_THE_LOGISTICS,
    USE_FREIGHT_FORWARDER,
    USE_INCOTERMS_IN_CONTRACTS,
...
ADVICE = {
    "market research": ADVICE_MARKET_RESEARCH_ARTICLES,
    "customer insight": ADVICE_CUSTOMER_INSIGHT_ARTICLES,
    "finance": ADVICE_FINANCE_ARTICLES,
    "business planning": ADVICE_BUSINESS_PLANNING_ARTICLES,
    "getting paid": ADVICE_GETTING_PAID_ARTICLES,
    "operations and compliance": ADVICE_OPERATIONS_AND_COMPLIANCE_ARTICLES,
}
...
def get_articles(
    ...
    :param group: Article Group: Advice, Export Readiness, Triage
