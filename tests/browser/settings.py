...
FORMS_API_MAILBOXES = {
    "DIT Enquiry unit": os.environ["FORMS_API_SENDER_EMAIL_DIT_ENQUIRIES"],
    "Events mailbox": os.environ["FORMS_API_SENDER_EMAIL_EVENTS"],
    "DSO mailbox": os.environ["FORMS_API_SENDER_EMAIL_DSO"],
    "Invest mailbox": os.environ["FORMS_API_SENDER_EMAIL_INVEST"],
    "Trade mailbox": os.environ["FORMS_API_SENDER_EMAIL_TRADE"],
}
