...
DIRECTORY_CMS_API_CLIENT_DEFAULT_TIMEOUT = int(os.getenv("DIRECTORY_CMS_API_CLIENT_DEFAULT_TIMEOUT", 5))
...
DIRECTORY_SSO_API_CLIENT_DEFAULT_TIMEOUT = int(os.getenv("DIRECTORY_SSO_API_CLIENT_DEFAULT_TIMEOUT", 5))
