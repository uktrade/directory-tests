...
DIRECTORY_FORMS_URL = os.environ["DIRECTORY_FORMS_URL"]
...
IP_RESTRICTOR_SKIP_CHECK_SECRET_CMS = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_CMS"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_EXRED = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_EXRED"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_FAB = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_FAB"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_FAS = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_FAS"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_FORMS = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_FORMS"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_INVEST = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_INVEST"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_SSO = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_SSO"]
IP_RESTRICTOR_SKIP_CHECK_SECRET_SUD = os.environ["IP_RESTRICTOR_SKIP_CHECK_SECRET_SUD"]
