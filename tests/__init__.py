...
class URLs(Enum):
    ...
    INTERNATIONAL_INDUSTRY_AGRICULTURAL_TECHNOLOGY = InternationalUrl("content/industries/agricultural-technology/")
    ...
    INTERNATIONAL_REGIONS_MIDLANDS = InternationalUrl("content/invest/uk-regions/midlands/")
    INTERNATIONAL_REGIONS_NORTHERN_IRELAND = InternationalUrl("content/invest/uk-regions/northern-ireland/")
    INTERNATIONAL_REGIONS_SOUTH_ENGLAND = InternationalUrl("content/invest/uk-regions/south-england/")
    INTERNATIONAL_REGIONS_NORTH_ENGLAND = InternationalUrl("content/invest/uk-regions/north-england/")
    ...
    INTERNATIONAL_REGIONS_SCOTLAND = InternationalUrl("content/invest/uk-regions/scotland/")
    ...
    INVEST_HPO_CONTACT = InternationalUrl("content/invest/high-potential-opportunities/contact/")
    INVEST_HPO_RAIL = InternationalUrl("content/invest/high-potential-opportunities/rail-infrastructure/")
    INVEST_HPO_FOOD = InternationalUrl("content/invest/high-potential-opportunities/food-production/")
    INVEST_HPO_LIGHTWEIGHT = InternationalUrl("content/invest/high-potential-opportunities/lightweight-structures/")
    ...
    INVEST_UK_SETUP_GUIDE_ESTABLISH_A_BASE = LegacyInvestUrl("uk-setup-guide/establish-base-business-uk/")
    INVEST_UK_SETUP_GUIDE_HIRE_SKILLED_WORKERS = LegacyInvestUrl("uk-setup-guide/hire-skilled-workers-your-uk-operations/")
    INVEST_UK_SETUP_GUIDE_OPEN_BANK_ACCOUNT = LegacyInvestUrl("uk-setup-guide/open-uk-business-bank-account/")
    INVEST_UK_SETUP_GUIDE_REGISTER_A_COMPANY = LegacyInvestUrl("uk-setup-guide/setup-your-business-uk/")
    INVEST_UK_SETUP_GUIDE_UK_TAX = LegacyInvestUrl("uk-setup-guide/understand-uk-tax-and-incentives/")
    ...
    INVEST_INDUSTRIES_ADVANCED_MANUFACTURING = LegacyInvestUrl("industries/advanced-manufacturing/")
    ...
    INVEST_INDUSTRIES_AUTOMOTIVE_RESEARCH_AND_DEVELOPMENT = LegacyInvestUrl("industries/automotive-research-and-development/")
    INVEST_INDUSTRIES_AUTOMOTIVE_SUPPLY_CHAIN = LegacyInvestUrl("industries/automotive-supply-chain/")
    INVEST_INDUSTRIES_CAPITAL_INVESTMENT = LegacyInvestUrl("industries/capital-investment/")
    INVEST_INDUSTRIES_CHEMICALS = LegacyInvestUrl("industries/chemicals/")
    INVEST_INDUSTRIES_CREATIVE_CONTENT_AND_PRODUCTION = LegacyInvestUrl("industries/creative-content-and-production/")
    INVEST_INDUSTRIES_CREATIVE_INDUSTRIES = LegacyInvestUrl("industries/creative-industries/")
    ...
    INVEST_INDUSTRIES_ELECTRICAL_NETWORKS = LegacyInvestUrl("industries/electrical-networks/")
    ...
    INVEST_INDUSTRIES_FINANCIAL_SERVICES = LegacyInvestUrl("industries/financial-services/")
    INVEST_INDUSTRIES_FINANCIAL_TECHNOLOGY = LegacyInvestUrl("industries/financial-technology/")
    INVEST_INDUSTRIES_FOOD_AND_DRINK = LegacyInvestUrl("industries/food-and-drink/")
    INVEST_INDUSTRIES_FOOD_SERVICE_AND_CATERING = LegacyInvestUrl("industries/food-service-and-catering/")
    INVEST_INDUSTRIES_FREE_FOODS = LegacyInvestUrl("industries/free-foods/")
    INVEST_INDUSTRIES_HEALTH_AND_LIFE_SCIENCES = LegacyInvestUrl("industries/health-and-life-sciences/")
    INVEST_INDUSTRIES_MEAT_POULTRY_AND_DAIRY = LegacyInvestUrl("industries/meat-poultry-and-dairy/")
    INVEST_INDUSTRIES_MEDICAL_TECHNOLOGY = LegacyInvestUrl("industries/medical-technology/")
    ...
    INVEST_INDUSTRIES_OFFSHORE_WIND_ENERGY = LegacyInvestUrl("industries/offshore-wind-energy/")
    INVEST_INDUSTRIES_OIL_AND_GAS = LegacyInvestUrl("industries/oil-and-gas/")
    INVEST_INDUSTRIES_PHARMACEUTICAL_MANUFACTURING = LegacyInvestUrl("industries/pharmaceutical-manufacturing/")
    ...
    PROFILE_FAB = ProfileUrl("business-profile/")
    ...
    PROFILE_ENROL_INDIVIDUAL_FINISHED = ProfileUrl("enrol/business-type/individual/finished/")
    ...
    PROFILE_ADD_PRODUCTS_AND_SERVICES = ProfileUrl("business-profile/add-expertise/products-and-services/")
    PROFILE_CASE_STUDY_EDIT = ProfileUrl("business-profile/case-study/{case_number}/details/")
